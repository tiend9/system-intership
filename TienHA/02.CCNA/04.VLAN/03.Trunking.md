...
> IEEE 802.1Q (còn được gọi là DOT1Q) là tiêu chuẩn mở do IEEE phát triển, được sử dụng rộng rãi trên mạng thiết bị của nhiều hãng khác nhau (Cisco, HP, Juniper...).
...
> ISL (Inter-Switch Link) là một giao thức trunking độc quyền của Cisco, được sử dụng để truyền tải nhiều VLAN qua một đường trục liên kết giữa các mạng thiết bị của Cisco. ISL chỉ hoạt động trên thiết bị Cisco và không phải tiêu chuẩn IEEE như 802.1Q.
