...
- Sau khi cấu hình xong mà ta tắt máy thì nhớ phải bật lại dịch vụ DHCP máy local trên con **DHCP Client** lên để máy VM có thể nhận IP. Phòng trường hợp gói `dhclient` cần cập nhật lại mà ta không có IP sẵn
