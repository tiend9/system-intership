...
=> Và **lưu ý quan trọng nhất** trong lab này là phải reset Network Manager trong máy local giống như reset network trong VM thì mới hết sạch lỗi `NXDOMAIN` (`Disable`/`Unable` là được). Và có thể Restart máy tính cũng được.

![DNS](./Lab_images/DNS_77.png)
