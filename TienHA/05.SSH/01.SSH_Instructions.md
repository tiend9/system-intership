...
## II.CÁC CHỨC NĂNG CHÍNH CỦA SSH
...
#### a. Local Port Forwarding (`ssh -L`) -> Chiều từ TRONG ra NGOÀI (hoặc giữa 2 Private)
...
#### b. Remote Port Forwarding (`ssh -R`) -> Chiều từ NGOÀI vào TRONG (Đúng như bạn nghĩ)
...
#### d. Proxy & Jump Host Access (ssh -J)
...
### 2. Port Forwarding (Chuyển tiếp cổng)
...
### 3. Giao thức truyền file trong SSH
