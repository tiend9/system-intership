...
|-----------|---------------------|----------------|
| **1. Cập nhật hệ thống** | `sudo dnf update -y` | Cập nhật danh sách gói và bản vá mới nhất. |
| **2. Cài đặt Apache (httpd)** | `sudo dnf install httpd -y` | Gói `httpd` là Apache Web Server trên CentOS/RHEL. |
