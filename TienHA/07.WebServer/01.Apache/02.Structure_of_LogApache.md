...
#### 3.1 Cách Add, Check Custom Log cho từng Virtual Host trên CentOS
...
Trên Ubuntu cũng na ná CentOS check GPT để cấu hình hiểu rõ vấn đề bản chất là được rồi
...
| **log_cgi / log_proxy / log_rewrite log** | Tùy module         | Một số module tự sinh log riêng (ví dụ: proxy error, rewrite debug...)       |
