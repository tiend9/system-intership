...
#### Bước 1: Tạo thư mục chứa file tĩnh
...
#### Bước 2: Tạo file chứa nội dung web tĩnh

```bash
sudo touch /var/www/mywebsite/index.html
```

#### Bước 3: Thêm nội dung vào web tĩnh
...
#### Bước 4: Tạo file Virtual Host riêng
...
#### Bước 5: Kích hoạt website `mywebsite` và tắt site mặc định
...
#### Bước 6: Kiểm tra cấu hình trước khi khởi động lại
