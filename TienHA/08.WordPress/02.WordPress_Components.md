...
wordpress/  
├── wp-admin/                    # Thư mục quản trị (Admin Dashboard - Giao diện quản trị)  
│   ├── css/                    # CSS cho admin  
...
│   └── ...  
│  
├── wp-content/                  # Thư mục nội dung (theme, plugin, upload - thư mục ta có thể tác động)  
...
│  
├── wp-includes/                 # Thư mục core WordPress (Đây là CoreFuncyions,Classes - KHÔNG SỬA!)  
│   ├── css/                    # CSS core  
