...
![WordPress](./Lab_images/WordPress_32.png)
...
CREATE USER 'wpuser_lemp'@'localhost' IDENTIFIED BY 'Tien9a';
...
```bash
sudo nano /etc/nginx/sites-available/lempsite
```

- Add Nội dung file `lempsite`:
...
![WordPress](./Lab_images/WordPress_33.png)
