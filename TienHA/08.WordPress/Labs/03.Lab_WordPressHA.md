...
![WordPress](./Lab_images/WordPress_49.png)
...
- Ta tạo các cụm máy ảo để thực hành:

![WordPress](./Lab_images/WordPress_34.png)

### **`Bước 2`: Cài và cấu hình MySQL và NFS Sever cho con máy `192.168.70.80`**
...
- Phân quyền cho WebNod trên con NFS Sever(2Web cũng tự cập nhật):
...
- Tạo Apache Virtual Host(Bước này làm trên 2 WebNode)
...
- Vào VPN để tắt con máy ảo webnode1 (`192.168.70.87`) và đăng nhập bằng 2 con LB (`192.168.70.83`) và WebNode2 (`192.168.70.89`)

![WordPress](./Lab_images/WordPress_45.png)

- `Ctrl+Shift+N` vào tab ẩn danh để truy cập 2 con LB (`192.168.70.83`) và Webnod 2 (`192.168.70.89`) và cả con Webnode 1 (`192.168.70.87`)

![WordPress](./Lab_images/WordPress_46.png)

![WordPress](./Lab_images/WordPress_47.png)

![WordPress](./Lab_images/WordPress_48.png)
