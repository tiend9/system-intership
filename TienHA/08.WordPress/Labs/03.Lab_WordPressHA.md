...
- Vào VPN để tắt con máy ảo webnod1 (`.87`) và đăng nhập bằng 2 con LB (`.83`) và WebNod2 (`.89`)

![WordPress](./Lab_images/WordPress_45.png)

- `Ctrl+Shift+N` vào tab ẩn danh để truy cập 2 con LB (`.83`) và Webnod 2 (`.89`) và cả con Webnod 1 (`.87`)
