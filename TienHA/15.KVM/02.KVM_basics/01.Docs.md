...
![KVMbasics](./images/KVM_basics_01.png)
...
![KVMbasics](./images/KVM_basics_02.png)
...
![KVMbasics](./images/KVM_basics_03.png)
...
Từ đó ta suy ra 3 kết luận **cực quan trọng**:

=> Vậy khi **QEMU** và **KVM** kết hợp với nhau thì **tạo thành 1 hypervisor type 1**. (Nhớ kĩ)
