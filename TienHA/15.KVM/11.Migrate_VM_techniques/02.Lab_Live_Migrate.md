...
Trường hợp nếu ta boot bằng bản `ubuntu 20.04` trở lên thì khả năng ngoài cấu hình file `default` của libvirt ra thì Libvirt quản lý việc mở port thông qua **systemd sockets**.
