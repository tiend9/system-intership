...
`Bước 1`: ta sẽ `ufw disable` và `start iptables.services` trên con Server.

`Bước 2`: Tắt ufw trên 2 con Backend

`Bước 3`: Ta sẽ viết 1 file script rules cho **iptables** trên con Server.
